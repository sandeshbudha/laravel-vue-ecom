...
<template>
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div v-for="(product,index) of products.data" class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                ...
                <div class="pt-4 pb-3 px-4">
                    ...
                    <div class="flex items-baseline mb-1 space-x-2">
                        <p class="text-xl text-primary font-semibold">Rs. {{ product.price }}</p>
                        <p class="text-sm text-gray-400 line-through">Rs. {{ product.price }}</p>
                    </div>
