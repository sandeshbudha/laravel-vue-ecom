        ...
        <form v-if="!loading" @submit.prevent="onSubmit">
            <div class="grid grid-cols-3">
                <div class="col-span-2 px-4 pt-5 pb-4">
                    ...
                    <CustomInput type="number" class="mb-2" v-model="product.price" label="Price" prepend="Rs." :errors="errors['price']"/>
...
import ImagePreview from "../core/ImagePreview.vue";
            ...
            .then(response => {
                ...
                if (response.status === 201) {
                    ...
                    if (close) {
                        ...
                        product.value = response.data
                        router.push({name: 'admin.products.edit', params: {id: response.data.id}})
                    }
                }
            })
            .catch(err => {
